/*TRES IMPORTANT CECI N'EST PAS MON CODE, C'est UN CODE OPENSOURCE
PRIS SUR LE SITE ARDUINO
LE BUT DE CE PROJET EST JUSTE DE VOIR LA PORTER D'un BUZZER PASSIVE
CE N'EST PAS GRAVE SI VOUS NE COMPRENEZ RIEN , JUSTE C'EST DROLE
A REALISER QUOI !!! */
